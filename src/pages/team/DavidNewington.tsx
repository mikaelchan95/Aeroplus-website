          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="prose max-w-none">
              <p className="text-lg text-gray-600 leading-relaxed">
                David Newington is a veteran leader in the payments industry with a truly global 
                perspective. His extensive background includes successfully spearheading AirPlus 
                International's expansion across the Asia Pacific region and establishing AirPlus 
                Australia.
              </p>
              
              <p className="text-lg text-gray-600 leading-relaxed">
                David's operational acumen, combined with his expertise in corporate travel, payment 
                systems, and technology integration, enables him to drive efficiency, operational 
                excellence, and sustainable growth throughout the organization.
              </p>
            </div>
